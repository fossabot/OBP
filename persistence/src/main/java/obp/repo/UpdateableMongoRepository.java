...
public class UpdateableMongoRepository<T, ID extends Serializable> extends SimpleMongoRepository<T, ID> implements UpdateableRepository<T, ID> {

  private MongoEntityInformation<T, ID> entityInformation;
  private MongoOperations operations;

  public UpdateableMongoRepository(MongoEntityInformation<T, ID> metadata, MongoOperations mongoOperations) {
