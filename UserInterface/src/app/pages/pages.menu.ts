// PAGES_MENU defines the left navigation.  Note that the "Create" menu option is dynamically
// added within pages.component.ts AddCreateMenuOption.
...
// The following commented out code is from the original Angular Template.  If you uncomment it
// and view the UI then you'll see parts of the demo that came with the template.  It has a
// few pages that demo different UI controls (e.g. checkboxes, charts, maps, etc).
